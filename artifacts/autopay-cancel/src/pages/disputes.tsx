...
import { AlertCircle, Copy, Download, FileText, ShieldAlert, Upload } from "lucide-react";
...
export default function DisputesPage() {
  ...
  const exportLetterPdf = () => {
    ...
    if (!printWindow) {
      setMessage("Popup blocked. Allow popups to export the letter.");
      return;
    }

    const escapedLetter = generatedLetter
      .replace(/&/g, "&amp;")
      .replace(/</g, "&lt;")
      .replace(/>/g, "&gt;");
...
<html>
<head>
  <title>Bank Stop Payment Letter</title>
  <style>
...
<body>
  <h1>Bank Stop Payment Letter</h1>
  <pre>${escapedLetter}</pre>
  <div class="disclaimer">This document was generated by AutoPay Cancel as a self-help template and is not legal or financial advice.</div>
          ...
          <Card className="rounded-2xl border-border/50 shadow-sm">
            ...
            <CardContent className="space-y-4">
              ...
              <Select value={form.paymentType} onValueChange={(v) => updateField("paymentType", v)}>
                ...
                <SelectContent>
                  <SelectItem value="ACH">ACH Withdrawal</SelectItem>
                  <SelectItem value="CARD">Recurring Card Charge</SelectItem>
                </SelectContent>
              </Select>
