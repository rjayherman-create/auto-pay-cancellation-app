...
const createTables = async () => {
  ...
  try {
    ...
    `);
    console.log('✓ Occasions table created');
    ...
    // Create indexes
    await client.query('CREATE INDEX IF NOT EXISTS idx_cards_occasion ON cards(occasion);');
    await client.query('CREATE INDEX IF NOT EXISTS idx_cards_status ON cards(status);');
    await client.query('CREATE INDEX IF NOT EXISTS idx_cards_batch_id ON cards(batch_id);');
    await client.query('CREATE INDEX IF NOT EXISTS idx_users_email ON users(email);');
    await client.query('CREATE INDEX IF NOT EXISTS idx_occasions_slug ON occasions(slug);');
